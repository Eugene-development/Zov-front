...
>
	...
	<div class="mt-auto px-8 pt-6 pb-4">
		<button
			...
			class="cta-btn group relative flex w-full cursor-pointer items-center justify-center gap-2.5 overflow-hidden rounded-lg px-5 py-3.5 text-sm font-medium tracking-wide text-white opacity-90 shadow-md transition-all duration-300 hover:shadow-lg active:scale-[0.98]"
		>
			<span class="cta-shimmer"></span>
			<svg
				class="relative z-10 h-4 w-4 shrink-0 transition-transform duration-500 group-hover:rotate-12"
