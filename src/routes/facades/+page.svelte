<script>
	...
	const facades = [
		...
		},
		{
			...
			description:
				'Фасады из натурального шпона дуба или ясеня — это классика, которая никогда не выходит из моды. Натуральная текстура дерева привносит в дом тепло и уют. Фасады из массива поддаются реставрации и с годами становятся только благороднее.',
