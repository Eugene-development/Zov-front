	...
	const facades = [
		...
		},
		{
			...
			details: {
				...
				coating: 'Эмаль, морилка, матовый лак, патина',
				thickness: '21 мм',
				minSize: '140 × 140 мм',
				maxSize: '2400 × 900 мм'
			}
		},
		{
			...
			title: 'Пластик HPL',
			description:
				'Максимально устойчивый к царапинам, ударам и температурам материал. Пластик HPL идеально имитирует текстуры бетона, камня или дерева, сохраняя при этом индустриальную строгость и премиальный вид.',
			image: '/images/facade_hpl.png',
			details: {
				base: 'МДФ / Влагостойкое ДСП',
				coating: 'Декоративный HPL пластик',
				thickness: '18 мм / 19 мм',
				minSize: '100 × 100 мм',
	...
	<div class="relative z-10 flex min-h-[80vh] items-center">
		<div class="mx-auto w-full max-w-7xl px-6">
			<div class="max-w-2xl">
				...
				>
					Фасады задают характер интерьера. От натурального массива до технологичного акрила: мы
					предлагаем материалы, которые сочетают в себе безупречную эстетику и долговечность.
				</p>
			</div>
		</div>
	</div>
	...
	<div class="relative mx-auto max-w-4xl px-6 text-center">
		<div class="opacity-0" class:animate-fade-up={sections['cta-section']}>
			...
			<p class="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-text-secondary">
				Ни одна фотография не передаст тактильных ощущений от бархатистого софт-тач пластика,
				прохлады глубокого глянца или теплоты натурального дерева. Посетите наш салон, чтобы
				прикоснуться к образцам.
			</p>
