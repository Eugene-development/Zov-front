...
<section class="relative overflow-hidden bg-primary py-28 lg:py-36" id="designers-hero">
	...
	<div class="relative mx-auto max-w-7xl px-6">
		<div class="max-w-2xl">
			...
			<p
				class="mt-7 max-w-xl text-base leading-relaxed text-white/60 opacity-0 md:text-lg"
				class:animate-fade-up={heroVisible}
				style="animation-delay: 0.6s"
			>
				Станьте партнёром фабрики ЗОВ — и предлагайте клиентам премиальную мебель с эксклюзивными
				условиями и приоритетным исполнением заказов
			</p>
		...
		<div class="grid gap-16 lg:grid-cols-2 lg:gap-24">
			...
			>
				...
				<div class="mt-10 space-y-4">
					{#each [{ icon: `<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z"/>`, label: '+7 915 400-00-20' }, { icon: `<path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75"/>`, label: 'design@zov.by' }] as contact}
