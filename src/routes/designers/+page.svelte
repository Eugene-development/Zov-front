	...
	const benefits = [
		{
			...
			text: 'До 22% на всю продукцию фабрики. Скидка применяется автоматически при заказе через личный кабинет дизайнера.'
		},
		{
...
<section class="relative overflow-hidden bg-primary py-28 lg:py-36" id="designers-hero">
	...
	<div class="relative mx-auto max-w-7xl px-6">
		...
		>
			{#each [{ value: '22%', label: 'максимальная скидка' }, { value: '500+', label: 'дизайнеров-партнёров' }, { value: '2 ч', label: 'время ответа менеджера' }, { value: '15 дн', label: 'срок производства' }] as stat}
