	...
	<div class="relative z-10 flex min-h-[85vh] items-center">
		<div class="mx-auto w-full max-w-7xl px-6">
			<div class="max-w-2xl">
				...
				>
					Создаём кухни и шкафы, которые сочетают безупречный дизайн, премиальные материалы и
		...
		<div class="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
			...
			>
				<div class="relative z-40 overflow-hidden">
					<img
						src="https://storage.yandexcloud.net/zovtop/logo/logo-2-sdgjkbnrklbmnk.jpg"
