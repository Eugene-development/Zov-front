	...
	const brands = [
		{
			...
			origin: 'Австрия',
			description:
				'Австрийская компания Blum — признанный лидер в мире фурнитуры. Это синоним безупречного движения, долговечности и инноваций. Механизмы Blum рассчитаны на срок службы всей мебели и даже больше, обеспечивая невероятную плавность закрывания и комфорт в каждом движении.',
			image: '/images/blum_hardware.png',
			features: [
				'Системы петель CLIP top BLUMOTION',
				'Подъемные механизмы AVENTOS',
				'Системы выдвижения LEGRABOX и TANDEMBOX',
				'Пожизненная гарантия на механизмы'
			],
			reverse: false
		},
		{
			...
			origin: 'Германия',
			description:
				'Немецкое качество Hettich устанавливает стандарты во всем мире. Интеллектуальные технологии сочетаются с лаконичным дизайном. Фурнитура Hettich обеспечивает максимальную стабильность даже для самых широких и тяжелых фасадов, делая вашу мебель надежной и совершенной.',
		...
		},
		{
			...
			origin: 'Польша',
			description:
				'Динамично развивающийся европейский бренд GTV предлагает современные решения для любой мебели. Это оптимальное сочетание высокого качества, новейших трендов в дизайне и доступности. Фурнитура GTV делает премиальный комфорт повседневной реальностью.',
			image: '/images/gtv_hardware.png',
			features: [
				'Ультратонкие ящики Axis Pro',
				'Системы скрытого монтажа Modern Box',
				'Петли с доводчиком Prestige',
	...
	<div class="mx-auto max-w-7xl px-6 text-center">
		<div class="opacity-0" class:animate-fade-up={sections['intro-section']}>
			...
			<p class="mx-auto mt-8 max-w-2xl text-base leading-relaxed text-text-secondary">
				...
				единого скрипа. Мы отобрали для вас лучшее оборудование от мировых лидеров.
			</p>
		</div>
	</div>
</section>
