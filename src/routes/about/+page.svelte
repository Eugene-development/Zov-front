<script>
	...
	const stats = [
		{ value: '3 000+', label: 'выполненных проектов ежегодно' },
		{ value: '2 000+', label: 'цветов и оттенков фасадов' },
		{ value: '120+', label: 'салонов по всей стране' },
		{ value: '30', label: 'лет на мебельном рынке' }
	];

	const principles = [
		{
			title: 'Открытость',
			text: 'Наши салоны работают ежедневно и мы всегда рады дать полную консультацию по всем вопросам.'
		},
		{
			title: 'Лояльность',
		...
		{
			title: 'Поддержка',
			text: 'В сложной ситуации при доставке или в процессе сборки мы решаем все вопросы в кратчайшие сроки.'
		},
		{
			title: 'Качество',
		...
		{
			title: 'Инновации',
			text: 'Наша компания внедряет современные решения и передовые технологии в производство мебели.'
		}
	];
</script>
	...
	<div class="relative z-10 flex min-h-screen items-center pb-24">
		<div class="mx-auto w-full max-w-7xl px-6">
			<div class="max-w-2xl">
				...
				>
					Наша компания располагает самой крупной сетью мебельных салонов фабрики «ЗОВ» в России.
					Предлагаем вам отличный сервис и доступные цены на мебель премиального качества.
				</p>
