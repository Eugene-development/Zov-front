...
<main class="bg-white">
		...
		<div class="relative z-10 mx-auto max-w-7xl px-6 text-center">
			{#if isVisible}
				<h1
					...
					class="mb-6 text-4xl font-light uppercase tracking-[0.1em] text-white lg:text-6xl"
				...
				<p
					...
					class="mx-auto max-w-3xl text-lg font-light leading-relaxed text-white/80 lg:text-xl"
				>
		...
		<div class="mx-auto flex max-w-7xl flex-col gap-32">
			...
			<div class="flex flex-col items-center gap-16 lg:flex-row">
				<div class="order-2 lg:order-1 lg:w-1/2">
					<div class="mb-4 text-sm font-medium uppercase tracking-[0.2em] text-accent">
						01. Проектирование
					</div>
					<h2
					...
					<p class="mb-6 leading-relaxed text-secondary">
						Дизайн начинается задолго до производства. Наши инженеры-технологи детально прорабатывают
						проект, учитывая миллиметровые зазоры, нагрузку на фурнитуру, особенности материалов и эргономику
						пространства. Мы применяем новейшее программное обеспечение для построения точных 3D-моделей
						вашей будущей кухни, исключая вероятность ошибок.
					</p>
			...
			<div class="flex flex-col items-center gap-16 lg:flex-row">
				...
				<div class="lg:w-1/2">
					...
					<p class="mb-6 leading-relaxed text-secondary">
						Производство кухонь ЗОВ — это симбиоз передовых роботизированных линий и ручного мастерства
						краснодеревщиков. Мы используем европейское оборудование сверхвысокой точности для распила
						и кромления, что гарантирует идеальную геометрию фасадов, долговечность фурнитуры и
			...
			<div class="relative grid grid-cols-1 gap-16 py-12 md:grid-cols-2">
				...
				<div class="p-8 lg:p-12">
					...
					<p class="leading-relaxed text-secondary">
						Каждая деталь вашей будущей кухни проходит многоуровневый контроль качества. Затем элементы
						бережно упаковываются в плотный многослойный картон с защитными профилями. Это полностью исключает
						любые повреждения, царапины и деформации при перемещении.
					</p>
				</div>
				...
				<div class="p-8 lg:p-12">
					...
					<p class="leading-relaxed text-secondary">
						...
						пневматическими креплениями для перевозки элитной мебели. Наши экипажи аккуратно поднимают изделия
						на ваш этаж, соблюдая чистоту и бережное отношение к ремонту.
					</p>
				</div>
			</div>
			...
			<div class="flex flex-col items-center gap-16 lg:flex-row">
				<div class="order-2 lg:order-1 lg:w-1/2">
					...
					<p class="mb-6 leading-relaxed text-secondary">
						Сборкой кухонь занимаются собственные бригады сертифицированных специалистов ЗОВ. Они монтируют
						корпуса, выставляют идеальные зазоры фасадов, подключают встраиваемую технику и интегрируют
						освещение. В результате вы получаете кухню мечты премиум-класса, полностью готовую к вашему первому кулинарному
						шедевру.
					</p>
					<div class="h-px w-24 bg-accent"></div>
				</div>
	...
	<section class="bg-surface-warm px-6 py-24">
		<div class="mx-auto max-w-7xl">
			<div class="mb-16 text-center">
				<h2
					class="mb-6 text-3xl font-light uppercase tracking-wide text-primary lg:text-4xl"
					style="font-family: var(--font-heading);"
				>
					Варианты стилистических решений
				</h2>
				<p class="mx-auto max-w-2xl text-lg font-light leading-relaxed text-secondary">
					Мы адаптируем индивидуальный проект под любой стиль. Выберите то, что идеально дополнит ваш интерьер. Каждая кухня от ЗОВ уникальна.
				</p>
			</div>
			...
			<div class="grid grid-cols-1 gap-8 md:grid-cols-3">
				...
				>
					...
					>
						<span class="text-xs font-medium uppercase tracking-[0.2em]">Заглушка: Современный</span>
					</div>
					<div class="p-8">
						<h3
				...
				>
					<div
						class="flex aspect-[4/3] w-full items-center justify-center bg-border-light text-primary/40 transition-colors duration-300 group-hover:bg-border-medium"
					>
						<span class="text-xs font-medium uppercase tracking-[0.2em]">Заглушка: Неоклассика</span>
					</div>
					<div class="p-8">
						<h3
							class="mb-3 text-xl font-light tracking-wide text-primary"
				...
				>
					<div
						class="flex aspect-[4/3] w-full items-center justify-center bg-border-light text-primary/40 transition-colors duration-300 group-hover:bg-border-medium"
					>
						<span class="text-xs font-medium uppercase tracking-[0.2em]">Заглушка: Лофт</span>
					</div>
					<div class="p-8">
						<h3
							class="mb-3 text-xl font-light tracking-wide text-primary"
	...
	<section class="bg-primary px-6 py-24 text-center text-white">
		<h2
			class="mb-8 text-3xl font-light uppercase tracking-wide lg:text-4xl"
			style="font-family: var(--font-heading);"
		>
			Хотите заказать кухню?
		</h2>
		<p class="mx-auto mb-10 max-w-2xl text-lg font-light text-white/70">
			Запишитесь в наши салоны для бесплатной консультации с дизайнером, знакомства с материалами и расчета
			стоимости вашего проекта.
		</p>
		<a
			href="/showrooms"
			class="inline-flex items-center gap-2 rounded-full border border-accent bg-accent px-8 py-4 text-sm tracking-wider text-white transition-all duration-300 hover:bg-transparent hover:text-accent"
		>
			Записаться в салон
