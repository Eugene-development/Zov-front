<script>
	...
	const steps = [
		...
		},
		{
			...
			icon: 'M14.25 10.5L16.5 12.75M14.25 13.5L16.5 11.25M6 10.5L8.25 12.75M6 13.5L8.25 11.25M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12z'
		},
		{
			title: 'Составление дизайн проекта',
			description:
				'Опираясь на ваши пожелания и данные замера, дизайнер разработает фотореалистичную 3D-модель вашей будущей мебели с идеальной эргономикой.',
			icon: 'M9.53 16.122a3 3 0 00-5.965 0M10 12a3 3 0 11-6 0 3 3 0 016 0zM19.47 16.122a3 3 0 00-5.965 0M20 12a3 3 0 11-6 0 3 3 0 016 0zM14.53 20.122a3 3 0 00-5.965 0M15 16a3 3 0 11-6 0 3 3 0 016 0z'
		},
		{
